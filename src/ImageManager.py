...
if imagetype != "test":
	config.imagemanager.imagefeed_OV = ConfigText(default="https://images.openvision.dedyn.io/json", fixed_size=False)
else:
	config.imagemanager.imagefeed_OV = ConfigText(default="https://images.openvision.dedyn.io/jsonall", fixed_size=False)
