...
#
	...
	def Stage6(self, result=None, retval=None, extra_args=None):
		...
		if self.Stage5:
			...
			self.Console.ePopen("sleep 80" + " &&" + " /sbin/init 4" + " &&" + " sleep 5" + " &&" + " tar -xzvf" + self.BackupDirectory + self.sel + " -C /" + " &&" + " rm -f /tmp/ExtraInstalledPlugins /tmp/backupimageversion /tmp/backupkernelversion" + " &&" + " /sbin/init 6", self.Stage1SettingsComplete, self.session.open(MessageBox, _("Restoring Plugins: Please Wait..."), MessageBox.TYPE_INFO))
		else:
